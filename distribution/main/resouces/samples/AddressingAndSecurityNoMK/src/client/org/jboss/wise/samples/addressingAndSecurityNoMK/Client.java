...
public class Client {
    ...
    public static void main( String[] args ) {
        try {
            WiseConfig config = new WiseJBWSRefletctionConfig("META-INF/jboss-wsse-client.xml", "Standard WSSecurity Client",
                                                              true, true, "/tmp/wise", false);
            WSDynamicClient client = WSDynamicClientFactory.newInstance(config).getJAXWSClient("http://127.0.0.1:8080/AddressingAndSecuritySampleNoMK?wsdl");
