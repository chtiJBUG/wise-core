 ...
 */
public class WSRMEnablerTest {

    @Test
    public void shouldFindVisitorImplWithIOC() {
        WSExtensionEnabler enabler = new WSRMEnabler();
    ...
    public void shouldFindVisitorImplWithWiseConfig() {
        ...
        WSExtensionEnabler enabler = new WSRMEnabler(config);
        assertThat(enabler.getDelegate(), is(ReflectionEnablerDelegate.class));
    }
    ...
    public void shouldDelegateToVisitor() {
        ...
        WSExtensionEnabler enabler = new WSRMEnabler(null, delegate);
        enabler.enable(ep);
        verify(delegate).visitWSRM(ep);
