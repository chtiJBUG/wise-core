...
public class WSMethodImplTest {
    ...
    public String methodForAnnotation( @WebParam( name = "annotation1", mode = Mode.IN ) Integer annotation1,
                                       @WebParam( name = "annotation2", mode = Mode.OUT ) String annotation2,
                                       @WebParam( name = "annotation3", mode = Mode.INOUT ) String annotation3 ) {
    ...
    public void shouldNotPermitEndPointNull() throws Exception {
        // using Method super class to avoid mockito problem in mocking final classes
