...
import it.javalinux.wise.core.consumer.WSConsumer;
import java.io.File;
...
public class WSDynamicClientImplTest {
    ...
    public void before() {
        ...
        builder.wsdlURL("foo").tmpDir("/tmp").targetPackage("it.javalinux.wise.test.mocks");
    }
    ...
    public void shouldProcessServices() throws Exception {
        WSConsumer consumerMock = mock(WSConsumer.class);
        String[] classes = {"it.javalinux.wise.test.mocks.Service1", "it.javalinux.wise.test.mocks.Service2"};
